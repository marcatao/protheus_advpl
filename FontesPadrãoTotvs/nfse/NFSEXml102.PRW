...
If lRetIss .And. lNTFS
	dDataComp := DateTitIss(aNota[01],aNota[02],cParcela,cCodMun)
	If !Empty(dDataComp)
...
If !Alltrim(SM0->M0_CODMUN) $ "3305505-4205407-3303906-3550308"
...
If (cTipo == "1") .or. (cTipo == "0" .And. cCodMun $ "3304557")
